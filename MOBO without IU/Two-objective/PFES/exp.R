...
AF_num<-10			#1:Random, 2:US, 3:EHVI, 4:e-PAL, 5:Proposed, 6:modified_proposed, 7:ParEGO, 8:SMSego, 9:MESMO, 10:PFES
...
sum((gamma_j_s_star*standard_normal_pdf(gamma_j_s_star))/(2*pnorm(gamma_j_s_star))-log(pnorm(gamma_j_s_star)))
