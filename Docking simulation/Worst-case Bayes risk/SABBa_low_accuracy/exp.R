...
result<-matrix(kekka,length(x),2)
result<- result[,1]-result[,2]+ref_p
...
##############################################################################################
		...
		check2<- (X_tilde_risk_epsilon_mat[,1]<th1)&(X_tilde_risk_epsilon_mat[,2]<th2)
			...
			c_k1<- (c4[1]-lcb_mat[id_num_diff_st2[new_design_num,3]:id_num_diff_st2[new_design_num,4],1])/(2*epsilon_mat[id_num_diff_st2[new_design_num,3]:id_num_diff_st2[new_design_num,4],1])
			c_k1<- c_k1*(c_k1>0)

			c_k2<- (c4[2]-lcb_mat[id_num_diff_st2[new_design_num,3]:id_num_diff_st2[new_design_num,4],2])/(2*epsilon_mat[id_num_diff_st2[new_design_num,3]:id_num_diff_st2[new_design_num,4],2])
			c_k2<- c_k2*(c_k2>0)
...
#############################################################################################################
		...
		risk_post_mean_mat<-matrix(numeric(429*2),429,2)
			...
			for(i in 1:429)
			{
			risk_post_mean_mat[i,]<-apply(rbind(post_mean_mat[id_num_diff_st2[i,3]:id_num_diff_st2[i,4],]),2,compute_DR)
			risk_epsilon_mat[i,]<-apply(cbind(abs(apply(rbind(ucb_mat[id_num_diff_st2[i,3]:id_num_diff_st2[i,4],]),2,compute_DR)-risk_post_mean_mat[i,]),abs(apply(rbind(lcb_mat[id_num_diff_st2[i,3]:id_num_diff_st2[i,4],]),2,compute_DR)-risk_post_mean_mat[i,])),1,max)
		...
		check2<- (X_tilde_risk_epsilon_mat[,1]<th1)&(X_tilde_risk_epsilon_mat[,2]<th2)
			...
			A1<-epsilon_mat[id_num_diff_st2[new_design_num,3]:id_num_diff_st2[new_design_num,4],]
			c_k1<- A1[,1]*compute_DR2(A1[,1])
			c_k2<- A1[,2]*compute_DR2(A1[,2])
